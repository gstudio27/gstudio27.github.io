(function ($, Drupal, drupalSettings) {
    ...
    Drupal.behaviors.video = {
        attach: function (context) {
            ...
            var videoID = document.getElementById('yt-video').getAttribute('href').split('v=')[1];
            var opener = document.getElementById('yt-video');
            var modalVideo = document.getElementsByClassName('modalVideo')[0];
            var closer = document.getElementsByClassName('modalVideo__close')[0];
            var bg = document.getElementsByClassName('modalVideo__bg')[0];
            var videoWrapper = document.getElementsByClassName('modalVideo__video')[0];

            var videoFrame = document.createElement("iframe");
            videoFrame.id = "yt-player";
            ...
            function openVideo(e) {
                ...
                document.getElementsByTagName('body')[0].classList.add('-jsNoScroll');
            }

            function closeVideo() {
                modalVideo.classList.remove('-open');
                document.getElementsByTagName('body')[0].classList.remove('-jsNoScroll');
                videoFrame.src = "https://www.youtube.com/embed/";
            }

            opener.addEventListener("click", openVideo, false);
            closer.addEventListener("click", closeVideo, false);
            bg.addEventListener("click", closeVideo, false);
        }
    }
